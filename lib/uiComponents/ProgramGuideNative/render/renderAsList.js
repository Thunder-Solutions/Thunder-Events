...
const renderAsList = ({ events, hiddenLocations, activeDay }) => {
    ...
    <div class="pg-table-wrapper">
      <table class="pg-table">
        <thead class="pg-table-header">
          <tr class="pg-row">
            <td class="pg-cell-wrapper pg-cell-wrapper--corner" onclick="${runMethod('toggleDateDialog', true)}">
              <div class="pg-cell"><span class="pg-corner-text">${activeDay}</span></div>
            </td>
          </tr>
        </thead>
        <tbody class="pg-body">
          ${mapString(events, event => {
