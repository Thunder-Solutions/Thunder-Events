...
const renderByLocation = ({ activeLocation, events, times: allTimes, sortBy, locations, hiddenLocations, activeDay, activeTime, marker, hasFloorPlan }) => {
              ...
              >
                <div class="pg-cell pg-cell--column-header pg-cell--column-header-location
                 ${getActiveClass(_location, 'pg-cell--column-header-active')}">
                  <button class="pg-location-name" onclick="${runMethod('showFloorPlan', _location)}" ${!hasFloorPlan ? 'disabled' : ''}>
                    <div class="pg-header-button ${!hasFloorPlan ? 'pg-disabled' : ''}">
...
Location</span>
                  ...
                  <button class="pg-header-button" onclick="${runMethod('selectSortBy', 'list')}">
                    ...
                    <span class="pg-button-label-text">View
by Time</span>
                  </button>
                </div>
              </th>
