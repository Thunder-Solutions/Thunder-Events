        ...
        <thead class="pg-header">
          <tr class="pg-row">
            ...
            ${mapString(locations, _location => /* html */`
              <th class="pg-cell-wrapper pg-cell-wrapper--column-header pg-cell-wrapper--column-header-location ${getActiveClass(_location, 'pg-cell-wrapper--column-header-active')}" onclick="${runMethod('showFloorPlan', _location)}">
