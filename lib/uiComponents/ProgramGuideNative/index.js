...
import { getDateInfo, getToday } from '../../utilities'
...
class ProgramGuideNative extends HTMLElement {
  ...
  #state = {
    ...
    sortBy: 'list', // location | allTime | now | nowOnly | time | favorites | list
    sortPref: 'list', // location | list
  ...
  constructor() {
    ...
    const actionMap = {
      ...
      print: getPrint,
      toggleChooseLocation: getToggleChooseLocation,
      toggleChooseTime: getToggleChooseTime,
      toggleSearch: getToggleSearch,
      toggleChooseDate: getToggleChooseDate,
      jumpToTime: getJumpToTime,
    }
    ...
    component.waitForFetch = getLocations().then(async locations => {
      ...
      component.setState({
        ...
        hasFloorPlan: typeof imageSrc === 'string' && imageSrc !== '',
      }, {
        pushState: false,
      })
    })
