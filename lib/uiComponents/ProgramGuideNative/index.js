...
class ProgramGuideNative extends HTMLElement {
  ...
  constructor() {
    ...
    component.floorPlan = {}
    component.floorPlanImage = new Image()
    component.floorPlanInteractive = false
    ...
    component.waitForFetch = getLocations().then(async locations => {
      ...
      setImageData(component) // keep loaded image in memory
  ...
  render({ loading } = {}) {
    ...
    if (component.view === 'guide') {
    ...
    } else if (component.view === 'floorPlan') {
      ...
      image.replaceWith(component.floorPlanImage)
    }
  ...
  toggleFloorPlanInteractive() {
    const component = this
    component.floorPlanInteractive = !component.floorPlanInteractive
    const { floorPlanInteractive, floorPlan, floorPlanImage } = component
