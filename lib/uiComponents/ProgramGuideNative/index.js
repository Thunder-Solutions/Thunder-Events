...
import { getDateInfo, compareDates } from '../../utilities'
...
class ProgramGuideNative extends HTMLElement {
  ...
  constructor() {
    ...
    component.waitForFetch = getLocations().then(async locations => {
      ...
      const activeDay = compareDates(currentDate, Object.keys(days)[0]) !== -1 && compareDates(currentDate, Object.keys(days)[days.length - 1]) !== 1 ?
