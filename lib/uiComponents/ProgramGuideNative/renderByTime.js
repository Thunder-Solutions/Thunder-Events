        ...
        <thead class="pg-header">
          <tr class="pg-row">
            <td class="pg-cell-wrapper pg-cell-wrapper--corner" onclick="${runMethod('toggleSortDialog', true)}">
              <div class="pg-cell pg-cell--corner"><i class="pg-more-icon"></i> <span class="pg-corner-text">${currentDay}</span></div>
            </td>
            ${mapString(times, ({ timeString }) => /* html */`
              <th class="pg-cell-wrapper pg-cell-wrapper--column-header pg-cell-wrapper--column-header-time">
                <div class="pg-cell pg-cell--column-header pg-cell--column-header-time">${timeString}</div>
              </th>
            `)}
          </tr>
        </thead>
            ...
            <tr class="pg-row">
              ...
              ${mapString(times, ({ date }) => {
                ...
                return /* html */`
                  ...
                  >
                    <div class="pg-cell pg-cell--${cellType} pg-cell--${cellType}-time">${eventName}</div>
                  </td>
                `
              })}
            </tr>
