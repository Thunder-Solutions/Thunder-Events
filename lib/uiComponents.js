...
export class ProgramGuideNative extends HTMLElement {
  ...
  toggleDialog(_bool) {
    ...
    component.dialogOpen = beyondThreshold ? false : bool
    component.render()
  }
  ...
  selectActiveLocation(_location) {
    ...
    component.dialogOpen = false // close upon selection
    component.render()
  }
  ...
  render({ loading } = {}) {
    ...
    tableTemplate.innerHTML = /* html */`
              ...
              <thead class="pg-header">
                <tr class="pg-row">
                  ...
                  ${mapString(locations, _location => /* html */`
                    <th class="pg-cell-wrapper pg-cell-wrapper--column-header ${getActiveClass(_location, 'pg-cell-wrapper--column-header-active')}" onclick="this.getRootNode().host.toggleDialog(true)">
      ...
      <dialog class="pg-dialog" ${component.dialogOpen ? 'open' : ''}>
